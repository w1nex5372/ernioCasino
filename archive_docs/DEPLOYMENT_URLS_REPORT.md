...
### Primary Domain
**Production URL**: `https://solana-battles-1.preview.emergentagent.com`
...
**Verification**:
```bash
curl -s https://solana-battles-1.preview.emergentagent.com | grep title
...
- Contains: `https://solana-battles-1.preview.emergentagent.com`

---

### 2. Backend API Deployment

**API Base URL**: `https://solana-battles-1.preview.emergentagent.com/api`
...
**Example Endpoints**:
- Price Endpoint: `https://solana-battles-1.preview.emergentagent.com/api/sol-eur-price`
- Purchase: `https://solana-battles-1.preview.emergentagent.com/api/purchase-tokens`
- Auth: `https://solana-battles-1.preview.emergentagent.com/api/auth/authenticate`

**Verification**:
```bash
curl -s https://solana-battles-1.preview.emergentagent.com/api/sol-eur-price
```
...
- Supervisor APP_URL: `https://solana-battles-1.preview.emergentagent.com`
- But frontend uses: `https://solana-battles-1.preview.emergentagent.com`
...
5. Send WebApp URL: `https://solana-battles-1.preview.emergentagent.com`
...
Photo: [upload icon]
Web App URL: https://solana-battles-1.preview.emergentagent.com
...
| Component | URL |
|-----------|-----|
| **Frontend served at** | `https://solana-battles-1.preview.emergentagent.com` |
| **Frontend API calls to** | `https://solana-battles-1.preview.emergentagent.com/api` |
| **Backend listening on** | `0.0.0.0:8001` (internal) |
| **Backend exposed at** | `https://solana-battles-1.preview.emergentagent.com/api` (via routing) |
...
| Component | URL |
|-----------|-----|
| **Telegram WebApp URL** | Should be: `https://solana-battles-1.preview.emergentagent.com` |
| **Frontend served at** | `https://solana-battles-1.preview.emergentagent.com` |
...
button = InlineKeyboardButton(
    text="🎰 Open Casino",
    web_app=WebAppInfo(url="https://solana-battles-1.preview.emergentagent.com")
)
...
└─────────────────┬───────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────┐
│  https://solana-battles-1.preview.emergentagent.com/api
...
- [x] HTTPS works: `https://solana-battles-1.preview.emergentagent.com`
...
5. Enter URL: `https://solana-battles-1.preview.emergentagent.com`
...
**Application URLs**:
```
Frontend:  https://solana-battles-1.preview.emergentagent.com
Backend:   https://solana-battles-1.preview.emergentagent.com/api
WebSocket: wss://casinosol.preview.emergentagent.com/socket.io
```

**API Endpoints** (Examples):
```
Price:     https://solana-battles-1.preview.emergentagent.com/api/sol-eur-price
Auth:      https://solana-battles-1.preview.emergentagent.com/api/auth/authenticate
Purchase:  https://solana-battles-1.preview.emergentagent.com/api/purchase-tokens
History:   https://solana-battles-1.preview.emergentagent.com/api/game-history
```

**Testing URLs**:
```bash
# Frontend
curl https://solana-battles-1.preview.emergentagent.com

# Backend API
curl https://solana-battles-1.preview.emergentagent.com/api/sol-eur-price

# Health Check
curl https://solana-battles-1.preview.emergentagent.com/api/health
```

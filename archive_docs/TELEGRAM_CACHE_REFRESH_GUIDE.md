...
```
Old: https://solanaplay-sync.preview.emergentagent.com?v=1401
New: https://solanaplay-sync.preview.emergentagent.com?v=8001
```
...
2. **Update Bot Menu URL** (via BotFather):
   ...
   Enter: https://solanaplay-sync.preview.emergentagent.com?v=8001
   ```
...
curl -s https://solanaplay-sync.preview.emergentagent.com | grep -o 'app-version.*8.0'

...
```
Old: https://casino-worker.preview.emergentagent.com?v=1401
New: https://casino-worker.preview.emergentagent.com?v=8001
```
...
2. **Update Bot Menu URL** (via BotFather):
   ...
   Enter: https://casino-worker.preview.emergentagent.com?v=8001
   ```
...
curl -s https://casino-worker.preview.emergentagent.com | grep -o 'app-version.*8.0'

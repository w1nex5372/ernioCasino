...
```
Old: https://casino-worker-1.preview.emergentagent.com?v=1401
New: https://casino-worker-1.preview.emergentagent.com?v=8001
```
...
2. **Update Bot Menu URL** (via BotFather):
   ...
   Enter: https://casino-worker-1.preview.emergentagent.com?v=8001
   ```
...
curl -s https://casino-worker-1.preview.emergentagent.com | grep -o 'app-version.*8.0'

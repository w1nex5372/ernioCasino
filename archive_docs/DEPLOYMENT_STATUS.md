...
**✅ CONFIRMED ACTIVE: `https://betdrop.preview.emergentagent.com`**
...
- **Port**: 8001
- **URL**: https://betdrop.preview.emergentagent.com/api
...
- **Port**: 3000
- **URL**: https://betdrop.preview.emergentagent.com
...
```bash
curl https://betdrop.preview.emergentagent.com/static/js/bundle.js | grep -o "room_ready"
```
...
```
preview_endpoint=https://betdrop.preview.emergentagent.com (INACTIVE)
...
```bash
curl https://betdrop.preview.emergentagent.com/socket.io/?EIO=4&transport=polling
```
...
- Go to: https://betdrop.preview.emergentagent.com
...
**Action Required**: 
1. Update Telegram Mini App to use `https://betdrop.preview.emergentagent.com`

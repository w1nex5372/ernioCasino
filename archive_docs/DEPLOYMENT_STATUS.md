...
**✅ CONFIRMED ACTIVE: `https://sol-casino-tg-1.preview.emergentagent.com`**
...
- **Port**: 8001
- **URL**: https://sol-casino-tg-1.preview.emergentagent.com/api
...
- **Port**: 3000
- **URL**: https://sol-casino-tg-1.preview.emergentagent.com
...
```bash
curl https://sol-casino-tg-1.preview.emergentagent.com/static/js/bundle.js | grep -o "room_ready"
```
...
```
preview_endpoint=https://sol-casino-tg-1.preview.emergentagent.com (INACTIVE)
...
```bash
curl https://sol-casino-tg-1.preview.emergentagent.com/socket.io/?EIO=4&transport=polling
```
...
- Go to: https://sol-casino-tg-1.preview.emergentagent.com
...
**Action Required**: 
1. Update Telegram Mini App to use `https://sol-casino-tg-1.preview.emergentagent.com`

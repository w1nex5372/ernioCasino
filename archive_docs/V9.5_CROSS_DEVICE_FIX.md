...
Backend URL: https://casino-worker.preview.emergentagent.com
...
API URL: https://casino-worker.preview.emergentagent.com/api/welcome-bonus-status
...
**If NOT connected**:
- Check URL: Should be `https://casino-worker.preview.emergentagent.com`

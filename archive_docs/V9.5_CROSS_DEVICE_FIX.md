...
Backend URL: https://solanaplay-sync.preview.emergentagent.com
...
API URL: https://solanaplay-sync.preview.emergentagent.com/api/welcome-bonus-status
...
**If NOT connected**:
- Check URL: Should be `https://solanaplay-sync.preview.emergentagent.com`

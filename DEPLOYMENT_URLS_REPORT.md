...
### Primary Domain
**Production URL**: `https://casinosol.preview.emergentagent.com`
...
**Domain**: `https://casinosol.preview.emergentagent.com`
...
**Verification**:
```bash
curl -s https://casinosol.preview.emergentagent.com | grep title
...
- Contains: `https://casinosol.preview.emergentagent.com`

---

### 2. Backend API Deployment

**API Base URL**: `https://casinosol.preview.emergentagent.com/api`
...
**Example Endpoints**:
- Price Endpoint: `https://casinosol.preview.emergentagent.com/api/sol-eur-price`
- Purchase: `https://casinosol.preview.emergentagent.com/api/purchase-tokens`
- Auth: `https://casinosol.preview.emergentagent.com/api/auth/authenticate`

**Verification**:
```bash
curl -s https://casinosol.preview.emergentagent.com/api/sol-eur-price
```
...
- Supervisor APP_URL: `https://eef3e92b-3552-4393-9f76-de6c90e0bd5e.preview.emergentagent.com`
- But frontend uses: `https://casinosol.preview.emergentagent.com`
...
5. Send WebApp URL: `https://casinosol.preview.emergentagent.com`
...
Photo: [upload icon]
Web App URL: https://casinosol.preview.emergentagent.com
...
| Component | URL |
|-----------|-----|
| **Frontend served at** | `https://casinosol.preview.emergentagent.com` |
| **Frontend API calls to** | `https://casinosol.preview.emergentagent.com/api` |
| **Backend listening on** | `0.0.0.0:8001` (internal) |
| **Backend exposed at** | `https://casinosol.preview.emergentagent.com/api` (via routing) |
...
| Component | URL |
|-----------|-----|
| **Telegram WebApp URL** | Should be: `https://casinosol.preview.emergentagent.com` |
| **Frontend served at** | `https://casinosol.preview.emergentagent.com` |
...
button = InlineKeyboardButton(
    text="🎰 Open Casino",
    web_app=WebAppInfo(url="https://casinosol.preview.emergentagent.com")
)
...
**Test Accessibility**:
```bash
curl -I https://casinosol.preview.emergentagent.com
...
└─────────────────┬───────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────┐
│  https://casinosol.preview.emergentagent.com/api
...
- [x] HTTPS works: `https://casinosol.preview.emergentagent.com`
...
5. Enter URL: `https://casinosol.preview.emergentagent.com`
...
**Application URLs**:
```
Frontend:  https://casinosol.preview.emergentagent.com
Backend:   https://casinosol.preview.emergentagent.com/api
WebSocket: wss://casinosol.preview.emergentagent.com/socket.io
```

**API Endpoints** (Examples):
```
Price:     https://casinosol.preview.emergentagent.com/api/sol-eur-price
Auth:      https://casinosol.preview.emergentagent.com/api/auth/authenticate
Purchase:  https://casinosol.preview.emergentagent.com/api/purchase-tokens
History:   https://casinosol.preview.emergentagent.com/api/game-history
```

**Testing URLs**:
```bash
# Frontend
curl https://casinosol.preview.emergentagent.com

# Backend API
curl https://casinosol.preview.emergentagent.com/api/sol-eur-price

# Health Check
curl https://casinosol.preview.emergentagent.com/api/health
```

...
```
Old: https://casinosol.preview.emergentagent.com?v=1401
New: https://casinosol.preview.emergentagent.com?v=8001
```
...
2. **Update Bot Menu URL** (via BotFather):
   ...
   Enter: https://casinosol.preview.emergentagent.com?v=8001
   ```
...
curl -s https://casinosol.preview.emergentagent.com | grep -o 'app-version.*8.0'
